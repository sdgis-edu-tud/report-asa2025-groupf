...
The prominent reason behind picking the dimensions of 300 meters is based on two main reasons:
...
![Visibility Analysis was done using create viewpoints and viewshed tools](../images/Visibility.png) The output layer, in raster format (.tiff), was aggregated into spatial units using zonal statistics. Then, the values were normalised to a 0–1 range, where higher values indicate greater visibility from the streams.
...
![Land use map](../images/Land%20Use.png)
...
![Normalized value of land use](../images/Land%20Use_Units.png)
