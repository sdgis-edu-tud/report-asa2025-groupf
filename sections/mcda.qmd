...
The output layer, in raster format (.tiff), was aggregated into spatial units using zonal statistics. Then, the values were normalized to a 0–1 range, where higher values indicate greater visibility from the streams.
