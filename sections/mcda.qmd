...
2. Accessibility — Aims to analyse how accessible Dresden’s streams are to the public, especially within walking distance. This is done using accessibility analysis combined with population data to show how well-connected the streams are to the area where most residents live.
...
![Shadow analysis done by the UMEP processing tool](../images/shadow_analysis_base.pdf)
...
![Proportioning the illuminated values within the spatial units](../images/shadow_proportions_2.pdf)
...
![Normalized values of shadow analysis](../images/shadow_analysis_normalised_3pm.pdf)
...
![Normalized value of accessibility](../images/Accessibility_Units.png)
