...
2. Environmental Quality —  Aims to identify crucial areas which are important for ecological habitation but presently lack in quality. The following sub-criteria are measured:  
   1. Water pollution  
   2. Plant health  
   3. Soil quality
...
[![Shadow analysis done by the UMEP processing tool](images/maintemplate 1.pdf)](images/shadow_analysis_base.pdf)
...
[![Proportioning the illuminated values within the spatial units](images/shadow_proportions_2.pdf)](images/shadow_proportions_2.pdf)
...
[![Normalized values of shadow analysis](images/shadow_analysis_normalised_3pm.pdf)](images/shadow_analysis_normalised_3pm.pdf)
