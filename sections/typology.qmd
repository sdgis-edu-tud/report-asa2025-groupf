...
cluster_colors <- c(
  ...
  "Marginal areas" = "#87CEEB"     # Sky Blue
)
...
Marginal areas will not suffer too much from the the heat island effect thanks to a large proportion of greenery, but they also do not provide much shade to protect from the sun.
...
It could therefore be interesting to analyse which if the dense urban areas have access in a close proximity to forest or marginal areas, that could be used during these events.

Finally, the available space gives us information about the potential for simple interventions in each area.
Marginal areas have the highest potential, meaning that they could be adapted to provide shelters in case of heat waves, for example by planting new trees.
